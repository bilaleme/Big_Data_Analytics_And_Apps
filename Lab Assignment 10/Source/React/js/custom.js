...
function renderHeaderImage(number){
...
//    console.log(dataURL)
    ...
    $('#img_plc').attr('src','Images/'+ number + '.jpg');

    $('#txt_area').hide();
    $('#meow').show();
    var tmp_img = document.createElement("img");
    tmp_img.src = 'Images/'+ number + '.jpg';
    console.log(tmp_img.src);
    ...
    console.log('rendering header image');
}


function checkRender(){
  var number = $('#dummy').html();
  if(number !=null && currentIndex != parseInt(number)){
      renderHeaderImage(number);
      console.log('bilal');
