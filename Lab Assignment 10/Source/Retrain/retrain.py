...
def get_actual_prediction(result_tensor,ground_truth_input):
    actual = tf.argmax(result_tensor,1)
...
def main(_):
  ...
  #get the actual vs predicted output
  actual, predict = get_actual_prediction(final_tensor,ground_truth_input)
  ...
  actuality,cPrediction = sess.run(
      [actual, prediction],
      feed_dict={bottleneck_input: train_bottlenecks,
                 ground_truth_input: train_ground_truth})
  ...
  print(confusion_matrix(actuality,cPrediction))
